...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="section-text">
        <div class="border_box_modified">
            <div class="m-l-sm m-r-sm m-t-sm m-b-sm">
